...
export class ZRequired<T extends AnyZ> extends Z<{
  ...
  protected readonly _hint = this._props.getOne('innerType').hint.replace(/^(\| undefined|undefined \|)$/, '')
    ...
    new ZRequired(
      {
        ...
        manifest: innerType._manifest.get() as ZManifestObject<Exclude<_ZOutput<T>, undefined>>,
