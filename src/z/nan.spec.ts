...
generateBaseSpec('ZNaN', ZNaN, {
  ...
  should: {
    ...
    '-100.123': { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    '-100': { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    '-10': { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    '-1': { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    '0': { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    '1': { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    '10': { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    '100': { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    '100.123': { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    yesterday: { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    now: { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    tomorrow: { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
    isostring: { parse: false, expectedIssue: { code: 'nan.base', message: '"value" must be a NaN' } },
  },
})
