...
generateBaseSpec('ZNull', ZNull, {
  ...
  should: {
    ...
    '-100.123': { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    '-100': { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    '-10': { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    '-1': { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    '0': { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    '1': { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    '10': { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    '100': { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    '100.123': { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    yesterday: { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    now: { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    tomorrow: { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
    isostring: { parse: false, expectedIssue: { code: 'any.only', message: '"value" must be [null]' } },
  },
})
