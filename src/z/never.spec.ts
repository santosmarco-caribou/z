...
generateBaseSpec('ZNever', ZNever, {
  ...
  should: {
    ...
    '-100.123': { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    '-100': { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    '-10': { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    '-1': { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    '0': { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    '1': { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    '10': { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    '100': { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    '100.123': { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    yesterday: { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    now: { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    tomorrow: { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
    isostring: { parse: false, expectedIssue: { code: 'any.unknown', message: '"value" is not allowed' } },
  },
})
